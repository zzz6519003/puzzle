...
def getConnection():
    ...
    db = web.database(dbn='mysql',db='puzzle',user='root',pw='anjuke',host='192.168.190.59',port=3306);
    return db
...
def getConnectionV2(name):
    db = {
        ...
        'ama':lambda:  web.database(dbn='mysql',db='Mobile',user='readonly_v2',pw='aNjuKe9dx1Pdw',host='10.10.8.7',port=3309),
        }[name]()
